...
void FRNTLFT_ESC_Init(void)
{
    ...
    /* Set values from customizer to CTRL */
        ...
        FRNTFRNTLFT_ESC_WritePeriod(FRNTLFT_ESC_QUAD_PERIOD_INIT_VALUE);
        FRNTFRNTLFT_ESC_WriteCounter(FRNTLFT_ESC_QUAD_PERIOD_INIT_VALUE);
        ...
        FRNTFRNTLFT_ESC_WritePeriod(FRNTLFT_ESC_TC_PERIOD_VALUE );

        #if (FRNTLFT_ESC__COMPARE == FRNTLFT_ESC_TC_COMP_CAP_MODE)
            FRNTFRNTLFT_ESC_WriteCompare(FRNTLFT_ESC_TC_COMPARE_VALUE);

            #if (1u == FRNTLFT_ESC_TC_COMPARE_SWAP)
                FRNTLFT_ESC_SetCompareSwap(1u);
                FRNTFRNTLFT_ESC_WriteCompareBuf(FRNTLFT_ESC_TC_COMPARE_BUF_VALUE);
        ...
        /* Initialize counter value */
            ...
            FRNTFRNTLFT_ESC_WriteCounter(1u);
        #elif(FRNTLFT_ESC__COUNT_DOWN == FRNTLFT_ESC_TC_COUNTER_MODE)
            FRNTFRNTLFT_ESC_WriteCounter(FRNTLFT_ESC_TC_PERIOD_VALUE);
        #else
            FRNTFRNTLFT_ESC_WriteCounter(0u);
        ...
        FRNTLFT_ESC_CONTROL_REG = FRNTLFT_ESC_CTRL_PWM_BASE_CONFIG;
            ...
            FRNTFRNTLFT_ESC_WriteCounter(FRNTLFT_ESC_PWM_PR_INIT_VALUE);
        #else
            ...
            /* Initialize counter value */
                ...
                FRNTFRNTLFT_ESC_WriteCounter(FRNTLFT_ESC_PWM_PERIOD_VALUE);
            #else 
                FRNTFRNTLFT_ESC_WriteCounter(0u);
        ...
        /* Set other values from customizer */
        FRNTFRNTLFT_ESC_WritePeriod(FRNTLFT_ESC_PWM_PERIOD_VALUE );
        FRNTFRNTLFT_ESC_WriteCompare(FRNTLFT_ESC_PWM_COMPARE_VALUE);

        #if (1u == FRNTLFT_ESC_PWM_COMPARE_SWAP)
            FRNTLFT_ESC_SetCompareSwap(1u);
            FRNTFRNTLFT_ESC_WriteCompareBuf(FRNTLFT_ESC_PWM_COMPARE_BUF_VALUE);
        #endif  /* (1u == FRNTLFT_ESC_PWM_COMPARE_SWAP) */

        #if (1u == FRNTLFT_ESC_PWM_PERIOD_SWAP)
            FRNTLFT_ESC_SetPeriodSwap(1u);
            FRNTFRNTLFT_ESC_WritePeriodBuf(FRNTLFT_ESC_PWM_PERIOD_BUF_VALUE);
...
/*******************************************************************************
* Function Name: FRNTFRNTLFT_ESC_WriteCounter
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: FRNTFRNTLFT_ESC_WritePeriod
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: FRNTFRNTLFT_ESC_WritePeriodBuf
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: FRNTFRNTLFT_ESC_WriteCompare
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: FRNTFRNTLFT_ESC_WriteCompareBuf
********************************************************************************
*
* Summary:
