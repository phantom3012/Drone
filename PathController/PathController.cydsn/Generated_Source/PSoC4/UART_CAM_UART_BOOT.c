...
/*******************************************************************************
* Function Name: UART_CAM_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_CAM_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_CAM_UartCyBtldrCommReset
****************************************************************************//**
*
...
void UART_CAM_UartCyBtldrCommReset(void)
{
    ...
    UART_CAM_SpiUartClearRxBuffer();
    UART_CAM_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UART_CAM_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UART_CAM_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UART_CAM_SpiUartGetRxBufferSize();
                    CyDelayUs(UART_CAM_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UART_CAM_SpiUartGetRxBufferSize());

                byteCount = UART_CAM_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) UART_CAM_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UART_CAM_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus UART_CAM_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UART_CAM_SpiUartPutArray(pData, (uint32) size);
